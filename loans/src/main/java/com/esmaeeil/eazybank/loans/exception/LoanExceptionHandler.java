...
public class LoanExceptionHandler {
    ...
    public ResponseEntity<ProblemDetail> handleException(Exception ex, ServletWebRequest request) {
        ...
        ProblemDetail problemDetail = problemDetailFactory(ex.getClass().getSimpleName(), ex, internalServerError, request);

        return ResponseEntity.status(internalServerError).body(problemDetail);
    }

    @ExceptionHandler(LoanAlreadyExistsException.class)
    public ResponseEntity<ProblemDetail> handleException(LoanAlreadyExistsException ex, ServletWebRequest request) {


        HttpStatus badRequest = HttpStatus.BAD_REQUEST;
        ProblemDetail problemDetail = problemDetailFactory(ex.getClass().getSimpleName(), ex, badRequest, request);
    ...
    public ResponseEntity<ProblemDetail> handleException(ResourceNotFoundException ex, ServletWebRequest request) {
        ...
        ProblemDetail problemDetail = problemDetailFactory(ex.getClass().getSimpleName(), ex, notFound, request);
